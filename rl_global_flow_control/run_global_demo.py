...
def cleanup():
    global sw_proc
    print '\n=== Cleanup ==='
    # Kill ALL simple_switch instances (not just this run's), because a
    # leftover from a previous run holds port 9090 + IPC and makes the next
    # switch "die" at startup.
